      ...
      <svg viewBox={`0 0 ${width} ${height}`} className="w-full">
        ...
        <defs>
          ...
          <pattern id="copperHatch" width="4" height="4" patternUnits="userSpaceOnUse">
            <path d="M0,4 L4,0" stroke="#999999" strokeWidth="0.5" />
          </pattern>
          <pattern id="hvHatch" width="4" height="4" patternUnits="userSpaceOnUse">
            <path d="M0,0 L4,4" stroke="#666666" strokeWidth="0.5" />
          </pattern>
        ...
        <rect
          ...
          strokeWidth="1.5"
        />
        <text x={centerX} y={centerY} fill="#000000" fontSize="10" textAnchor="middle" fontWeight="bold">
          CORE
        </text>
        ...
        <rect
          ...
          strokeWidth="2"
        />
        <text x={centerX - (lvInnerR + lvOuterR) / 2} y={centerY} fill="#000000" fontSize="8" textAnchor="middle" fontWeight="bold">
          LV
        </text>
        ...
        <rect
          ...
          strokeWidth="2"
        />
        <text x={centerX - (hvInnerR + hvOuterR) / 2} y={centerY} fill="#000000" fontSize="8" textAnchor="middle" fontWeight="bold">
          HV
        </text>
        ...
        />
        <text x={centerX + 5} y={centerY - Math.max(lvH, hvH) / 2 - 20} fill="#000000" fontSize="7">
          CL
        </text>
        ...
        <g transform="translate(10, 50)">
          <text x="0" y="0" fill="#000000" fontSize="9" fontWeight="bold">INSULATION CLEARANCES</text>
          <line x1="0" y1="5" x2="140" y2="5" stroke="#000000" />
          {[
            ...
            <g key={i}>
              <text x="5" y={20 + i * 14} fill="#000000" fontSize="8">{label}</text>
              <text x="140" y={20 + i * 14} fill="#000000" fontSize="8" textAnchor="end" fontWeight="bold">{value}</text>
            </g>
          ))}
        </g>
        ...
        <g transform={`translate(${width - 200}, 50)`}>
          <rect x="0" y="0" width="190" height="95" fill="#ffffff" stroke="#000000" rx="3" />
          <text x="95" y="15" fill="#000000" fontSize="9" textAnchor="middle" fontWeight="bold">LV WINDING</text>
          <line x1="5" y1="20" x2="185" y2="20" stroke="#000000" />
          {[
            ...
            <g key={i}>
              <text x="10" y={35 + i * 12} fill="#000000" fontSize="7">{label}</text>
              <text x="180" y={35 + i * 12} fill="#000000" fontSize="7" textAnchor="end">{value}</text>
            </g>
          ))}
        </g>
        ...
        <g transform={`translate(${width - 200}, 155)`}>
          <rect x="0" y="0" width="190" height="95" fill="#ffffff" stroke="#000000" rx="3" />
          <text x="95" y="15" fill="#000000" fontSize="9" textAnchor="middle" fontWeight="bold">HV WINDING</text>
          <line x1="5" y1="20" x2="185" y2="20" stroke="#000000" />
          {[
        ...
        <g transform={`translate(${width - 200}, 260)`}>
          <rect x="0" y="0" width="190" height="80" fill="#ffffff" stroke="#000000" rx="3" />
          <text x="95" y="15" fill="#000000" fontSize="9" textAnchor="middle" fontWeight="bold">CONDUCTOR DATA</text>
          <line x1="5" y1="20" x2="185" y2="20" stroke="#000000" />
          {[
        ...
        <g transform={`translate(${width - 200}, ${height - 90})`}>
          <rect x="0" y="0" width="190" height="80" fill="#ffffff" stroke="#000000" rx="3" />
          <text x="95" y="15" fill="#000000" fontSize="9" textAnchor="middle" fontWeight="bold">LEGEND</text>
          <rect x="10" y="25" width="20" height="12" fill="#cccccc" stroke="#000000" />
          <text x="35" y="34" fill="#000000" fontSize="7">Core (Silicon Steel)</text>
          <rect x="10" y="42" width="20" height="12" fill="url(#copperHatch)" stroke="#000000" strokeWidth="1.5" />
          <text x="35" y="51" fill="#000000" fontSize="7">LV Winding ({lvWinding.conductorType})</text>
          <rect x="10" y="59" width="20" height="12" fill="url(#hvHatch)" stroke="#000000" strokeWidth="1.5" />
          <text x="35" y="68" fill="#000000" fontSize="7">HV Winding ({hvWinding.conductorType})</text>
        </g>
      </svg>
    </div>
  );
